...
<head>
  ...
  <title>Social Media – Luxora Media</title>
...
<?php include 'user-nav.php'; ?>
  ...
  <main>
    ...
    <section class="d-flex align-items-center" style="min-height:50vh;padding-top:80px;background:radial-gradient(ellipse at 30% 40%, rgba(212,175,55,0.06), transparent 60%);">
      <div class="container">
        <div class="max-w-3xl fade-up visible">
          <span class="section-badge"><i class="fas fa-share-alt me-1"></i> Service</span>
          <h1 class="section-title">Social <span class="gold">Media</span></h1>
          <p class="text-secondary fs-5 mt-3">Engaging content strategy, community management, and growth across all major platforms.</p>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-hashtag me-1"></i> What We Do</span>
          <h2 class="section-title">Social <span class="gold">Services</span></h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-pen-fancy fs-1 text-gold mb-2"></i><h4 class="fw-bold">Content Creation</h4><p class="text-secondary small">Engaging posts, stories, and reels.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-users fs-1 text-gold mb-2"></i><h4 class="fw-bold">Community Management</h4><p class="text-secondary small">Engage with your audience daily.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-chart-line fs-1 text-gold mb-2"></i><h4 class="fw-bold">Growth Strategy</h4><p class="text-secondary small">Data-driven growth tactics.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-ad fs-1 text-gold mb-2"></i><h4 class="fw-bold">Paid Ads</h4><p class="text-secondary small">Targeted advertising campaigns.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-analytics fs-1 text-gold mb-2"></i><h4 class="fw-bold">Analytics</h4><p class="text-secondary small">Track and optimize performance.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-calendar-check fs-1 text-gold mb-2"></i><h4 class="fw-bold">Content Calendar</h4><p class="text-secondary small">Plan and schedule posts efficiently.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-globe me-1"></i> Platforms</span>
          <h2 class="section-title">We Manage <span class="gold">All Platforms</span></h2>
        </div>
        <div class="d-flex flex-wrap justify-content-center gap-4 mt-4">
          <span class="glass px-4 py-3 rounded-pill text-lg"><i class="fab fa-instagram me-2 text-gold"></i>Instagram</span>
          <span class="glass px-4 py-3 rounded-pill text-lg"><i class="fab fa-facebook me-2 text-gold"></i>Facebook</span>
          <span class="glass px-4 py-3 rounded-pill text-lg"><i class="fab fa-linkedin-in me-2 text-gold"></i>LinkedIn</span>
          <span class="glass px-4 py-3 rounded-pill text-lg"><i class="fab fa-tiktok me-2 text-gold"></i>TikTok</span>
          <span class="glass px-4 py-3 rounded-pill text-lg"><i class="fab fa-x-twitter me-2 text-gold"></i>Twitter/X</span>
          <span class="glass px-4 py-3 rounded-pill text-lg"><i class="fab fa-youtube me-2 text-gold"></i>YouTube</span>
        </div>
      </div>
    </section>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-tag me-1"></i> Social Media Pricing</span>
        ...
        <div class="row g-4 mt-3">
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <div class="fs-1 fw-black mt-2">$149<span class="text-secondary fs-6 fw-normal">/mo</span></div>
              <p class="text-secondary small mt-1">Essential social presence</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> 2 Platforms</li>
                <li><i class="fas fa-check-circle"></i> 10 Posts per Month</li>
                <li><i class="fas fa-check-circle"></i> Basic Analytics</li>
                <li><i class="fas fa-check-circle"></i> Email Support</li>
              </ul>
              <a href="contact.php?service=Social%20Media&plan=Basic&amount=149" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card popular">
              ...
              <div class="fs-1 fw-black mt-2">$349<span class="text-secondary fs-6 fw-normal">/mo</span></div>
              <p class="text-secondary small mt-1">Growing your brand</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> 4 Platforms</li>
                <li><i class="fas fa-check-circle"></i> 30 Posts per Month</li>
                <li><i class="fas fa-check-circle"></i> Community Management</li>
                <li><i class="fas fa-check-circle"></i> Advanced Analytics</li>
                <li><i class="fas fa-check-circle"></i> Priority Support</li>
              </ul>
              <a href="contact.php?service=Social%20Media&plan=Pro&amount=349" class="btn-primary-custom w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <p class="text-secondary small mt-1">Full-scale social strategy</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> All Platforms</li>
                <li><i class="fas fa-check-circle"></i> Unlimited Posts</li>
                <li><i class="fas fa-check-circle"></i> Dedicated Social Manager</li>
                <li><i class="fas fa-check-circle"></i> Full Analytics Suite</li>
                <li><i class="fas fa-check-circle"></i> Paid Ads Management</li>
                <li><i class="fas fa-check-circle"></i> 24/7 Support</li>
              </ul>
              <a href="contact.php?service=Social%20Media&plan=Enterprise" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Contact Us</a>
            </div>
          </div>
        </div>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">Social <span class="gold">Questions</span></h2>
        </div>
        <div class="row justify-content-center mt-3">
          <div class="col-lg-8">
            <div class="faq-item"><div class="faq-q"><span>Which platforms do you manage?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Instagram, Facebook, LinkedIn, TikTok, Twitter/X, and YouTube.</div></div>
            <div class="faq-item"><div class="faq-q"><span>Do you create content?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Yes! We create engaging posts, stories, reels, and videos for all platforms.</div></div>
            <div class="faq-item"><div class="faq-q"><span>Can you grow my following?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">We use data-driven strategies to grow your following organically and through paid ads.</div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 position-relative overflow-hidden">
      ...
      <div class="container position-relative z-1">
        <div class="glass-gold rounded-4 p-5 text-center max-w-4xl mx-auto fade-up">
          <h2 class="section-title" style="font-size:clamp(2rem,4vw,3.5rem);">Ready to <span class="gold">Grow</span> Your Social Presence?</h2>
          <p class="text-secondary fs-5 mt-3">Let's build a social strategy that drives engagement and growth.</p>
