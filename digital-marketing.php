...
<head>
  ...
  <title>Digital Marketing – Luxora Media</title>
    ...
    <section class="d-flex align-items-center" style="min-height:50vh;padding-top:80px;background:radial-gradient(ellipse at 30% 40%, rgba(212,175,55,0.06), transparent 60%);">
      <div class="container">
        <div class="max-w-3xl fade-up visible">
          <span class="section-badge"><i class="fas fa-bullhorn me-1"></i> Service</span>
          <h1 class="section-title">Digital <span class="gold">Marketing</span></h1>
          <p class="text-secondary fs-5 mt-3">Paid ads, social media campaigns, and conversion optimization to grow your business online.</p>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-chart-line me-1"></i> What We Do</span>
          <h2 class="section-title">Marketing <span class="gold">Services</span></h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-ad fs-1 text-gold mb-2"></i><h3 class="fw-bold">Paid Ads</h3><p class="text-secondary small mt-1">Google, Facebook, Instagram & LinkedIn ads.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-rocket fs-1 text-gold mb-2"></i><h3 class="fw-bold">Campaign Strategy</h3><p class="text-secondary small mt-1">Data-driven marketing campaigns.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-percent fs-1 text-gold mb-2"></i><h3 class="fw-bold">Conversion Optimization</h3><p class="text-secondary small mt-1">Turn visitors into customers.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-pie-chart fs-1 text-gold mb-2"></i><h3 class="fw-bold">Analytics & Reporting</h3><p class="text-secondary small mt-1">Track, measure, and optimize.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-envelope-open-text fs-1 text-gold mb-2"></i><h3 class="fw-bold">Email Marketing</h3><p class="text-secondary small mt-1">Nurture leads with targeted emails.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-globe fs-1 text-gold mb-2"></i><h3 class="fw-bold">Digital Strategy</h3><p class="text-secondary small mt-1">Custom marketing roadmaps.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">Marketing <span class="gold">Plans</span></h2>
        ...
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <p class="text-secondary small mt-1">Essential marketing</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> 1 Platform Ads</li>
                <li><i class="fas fa-check-circle"></i> $500 Ad Spend</li>
                <li><i class="fas fa-check-circle"></i> Monthly Reports</li>
                <li><i class="fas fa-check-circle"></i> Email Support</li>
              </ul>
              <a href="contact.php?service=Digital%20Marketing&plan=Starter&amount=499" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          <div class="col-md-4 fade-up">
            <div class="pricing-card popular">
              ...
              <p class="text-secondary small mt-1">Full-scale marketing</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> 3 Platforms Ads</li>
                <li><i class="fas fa-check-circle"></i> $1,500 Ad Spend</li>
                <li><i class="fas fa-check-circle"></i> A/B Testing</li>
                <li><i class="fas fa-check-circle"></i> Weekly Reports</li>
                <li><i class="fas fa-check-circle"></i> Strategy Calls</li>
              </ul>
              <a href="contact.php?service=Digital%20Marketing&plan=Pro&amount=999" class="btn-primary-custom w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          <div class="col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <p class="text-secondary small mt-1">Full marketing agency</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> All Platforms</li>
                <li><i class="fas fa-check-circle"></i> Custom Ad Spend</li>
                <li><i class="fas fa-check-circle"></i> Dedicated Manager</li>
                <li><i class="fas fa-check-circle"></i> Full Analytics Suite</li>
                <li><i class="fas fa-check-circle"></i> 24/7 Support</li>
              </ul>
              <a href="contact.php?service=Digital%20Marketing&plan=Enterprise" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Contact Us</a>
            </div>
          </div>
        </div>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">Marketing <span class="gold">Questions</span></h2>
        </div>
        <div class="row justify-content-center mt-3">
          <div class="col-lg-8">
            <div class="faq-item"><div class="faq-q"><span>What platforms do you advertise on?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Google Ads, Facebook, Instagram, LinkedIn, TikTok, and more.</div></div>
            <div class="faq-item"><div class="faq-q"><span>How much budget do I need?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">We recommend a minimum of $500/month for testing, but we work with all budgets.</div></div>
            <div class="faq-item"><div class="faq-q"><span>When will I see results?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">You'll see initial results within 2‑4 weeks, with significant improvements in 2‑3 months.</div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 position-relative overflow-hidden">
      ...
      <div class="container position-relative z-1">
        <div class="glass-gold rounded-4 p-5 text-center max-w-4xl mx-auto fade-up">
          <h2 class="section-title" style="font-size:clamp(2rem,4vw,3.5rem);">Ready to <span class="gold">Grow</span> Your Business?</h2>
          <p class="text-secondary fs-5 mt-3">Let's create a marketing strategy that drives results.</p>
