    ...
    <section class="d-flex align-items-center" style="min-height:50vh;padding-top:80px;background:radial-gradient(ellipse at 30% 40%, rgba(212,175,55,0.06), transparent 60%);">
      <div class="container">
        <div class="max-w-3xl fade-up visible">
          <span class="section-badge"><i class="fas fa-magnifying-glass-chart me-1"></i> Service</span>
          <h1 class="section-title">Search Engine <span class="gold">Optimization</span></h1>
          <p class="text-secondary fs-5 mt-3">Dominate search results, drive organic traffic, and grow your business with data-driven SEO strategies.</p>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-rocket me-1"></i> What We Do</span>
          <h2 class="section-title">SEO <span class="gold">Services</span></h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-search fs-1 text-gold mb-2"></i><h3 class="fw-bold">Keyword Research</h3><p class="text-secondary small mt-1">Find high-impact keywords that drive qualified traffic.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-file-alt fs-1 text-gold mb-2"></i><h3 class="fw-bold">On-Page SEO</h3><p class="text-secondary small mt-1">Optimize content, meta tags, and site structure.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-link fs-1 text-gold mb-2"></i><h3 class="fw-bold">Link Building</h3><p class="text-secondary small mt-1">Build high-quality backlinks for authority.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-chart-simple fs-1 text-gold mb-2"></i><h3 class="fw-bold">SEO Analytics</h3><p class="text-secondary small mt-1">Track rankings and optimize performance.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-mobile-screen fs-1 text-gold mb-2"></i><h3 class="fw-bold">Mobile Optimization</h3><p class="text-secondary small mt-1">Ensure your site is mobile-friendly.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-bullhorn fs-1 text-gold mb-2"></i><h3 class="fw-bold">Local SEO</h3><p class="text-secondary small mt-1">Dominate local search results.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">How <span class="gold">It Works</span></h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-search fs-1 text-gold mb-2"></i><h4 class="fw-bold">Audit</h4><p class="text-secondary small">Analyze your current SEO.</p></div></div>
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-pen-fancy fs-1 text-gold mb-2"></i><h4 class="fw-bold">Strategy</h4><p class="text-secondary small">Create a custom plan.</p></div></div>
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-cogs fs-1 text-gold mb-2"></i><h4 class="fw-bold">Execute</h4><p class="text-secondary small">Implement optimizations.</p></div></div>
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-chart-line fs-1 text-gold mb-2"></i><h4 class="fw-bold">Monitor</h4><p class="text-secondary small">Track & improve results.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">SEO <span class="gold">Plans</span></h2>
        ...
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <div class="fs-1 fw-black mt-2">$399<span class="text-secondary fs-6 fw-normal">/mo</span></div>
              <p class="text-secondary small mt-1">Essential SEO foundation</p>
              <ul class="feature-list mt-3">
                ...
                <li><i class="fas fa-check-circle"></i> 5 Keywords Tracked</li>
              </ul>
              <a href="contact.php?service=SEO&plan=Basic&amount=399" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          <div class="col-md-4 fade-up">
            <div class="pricing-card popular">
              <h5 class="fw-bold">Pro</h5>
              <div class="fs-1 fw-black mt-2">$799<span class="text-secondary fs-6 fw-normal">/mo</span></div>
              <p class="text-secondary small mt-1">Advanced SEO strategy</p>
              <ul class="feature-list mt-3">
                ...
                <li><i class="fas fa-check-circle"></i> 20 Keywords Tracked</li>
                <li><i class="fas fa-check-circle"></i> Competitor Analysis</li>
              </ul>
              <a href="contact.php?service=SEO&plan=Pro&amount=799" class="btn-primary-custom w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          <div class="col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <p class="text-secondary small mt-1">Full-scale SEO dominance</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> Everything in Pro</li>
                <li><i class="fas fa-check-circle"></i> Unlimited Keywords</li>
                <li><i class="fas fa-check-circle"></i> Dedicated SEO Manager</li>
                <li><i class="fas fa-check-circle"></i> Custom Strategy</li>
                <li><i class="fas fa-check-circle"></i> Weekly Reports</li>
              </ul>
              <a href="contact.php?service=SEO&plan=Enterprise" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Contact Us</a>
            </div>
          </div>
        </div>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">SEO <span class="gold">Questions</span></h2>
        </div>
        <div class="row justify-content-center mt-3">
          <div class="col-lg-8">
            <div class="faq-item"><div class="faq-q"><span>How long does SEO take to show results?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Typically 3‑6 months, depending on competition and keywords.</div></div>
            <div class="faq-item"><div class="faq-q"><span>Do you guarantee rankings?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">We guarantee we'll use ethical strategies to improve your rankings, but we cannot guarantee specific positions due to algorithm changes.</div></div>
            <div class="faq-item"><div class="faq-q"><span>What's included in your SEO packages?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Keyword research, on-page optimization, content strategy, link building, analytics reporting, and ongoing monitoring.</div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 position-relative overflow-hidden">
      ...
      <div class="container position-relative z-1">
        <div class="glass-gold rounded-4 p-5 text-center max-w-4xl mx-auto fade-up">
          <h2 class="section-title" style="font-size:clamp(2rem,4vw,3.5rem);">Ready to <span class="gold">Rank Higher</span>?</h2>
          <p class="text-secondary fs-5 mt-3">Let's optimize your website and dominate the search results.</p>
