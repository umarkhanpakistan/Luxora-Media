...
<head>
  ...
  <title>AI Chatbots – Luxora Media</title>
...
<?php include 'user-nav.php'; ?>
  ...
  <main>
    ...
    <section class="d-flex align-items-center" style="min-height:50vh;padding-top:80px;background:radial-gradient(ellipse at 30% 40%, rgba(212,175,55,0.06), transparent 60%);">
      <div class="container">
        <div class="max-w-3xl fade-up visible">
          <span class="section-badge"><i class="fas fa-robot me-1"></i> Service</span>
          <h1 class="section-title">AI <span class="gold">Chatbots</span></h1>
          <p class="text-secondary fs-5 mt-3">Intelligent chatbots that automate customer support, generate leads, and boost engagement 24/7.</p>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-microchip me-1"></i> Features</span>
          <h2 class="section-title">Smart <span class="gold">Automation</span></h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-comment-dots fs-1 text-gold mb-2"></i><h4 class="fw-bold">24/7 Support</h4><p class="text-secondary small">Never miss a customer query again with round-the-clock assistance.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-rocket fs-1 text-gold mb-2"></i><h4 class="fw-bold">Lead Generation</h4><p class="text-secondary small">Capture and qualify leads automatically with intelligent conversations.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-brain fs-1 text-gold mb-2"></i><h4 class="fw-bold">AI-Powered</h4><p class="text-secondary small">Natural language processing for human-like conversations.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-plug fs-1 text-gold mb-2"></i><h4 class="fw-bold">Easy Integration</h4><p class="text-secondary small">Works with websites, WhatsApp, and social media platforms.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-chart-line fs-1 text-gold mb-2"></i><h4 class="fw-bold">Analytics</h4><p class="text-secondary small">Track performance and optimize conversations with data insights.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-shield-halved fs-1 text-gold mb-2"></i><h4 class="fw-bold">Secure</h4><p class="text-secondary small">Enterprise-grade security for your data and conversations.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-tag me-1"></i> Chatbot Pricing</span>
        ...
        <div class="row g-4 mt-3">
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <div class="fs-1 fw-black mt-2">$99<span class="text-secondary fs-6 fw-normal">/mo</span></div>
              <p class="text-secondary small mt-1">Perfect for getting started</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> 1 Bot</li>
                <li><i class="fas fa-check-circle"></i> 500 Conversations</li>
                <li><i class="fas fa-check-circle"></i> Website Integration</li>
                <li><i class="fas fa-check-circle"></i> Basic Analytics</li>
                <li><i class="fas fa-check-circle"></i> Email Support</li>
              </ul>
              <a href="contact.php?service=AI%20Chatbots&plan=Basic&amount=99" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card popular">
              ...
              <div class="fs-1 fw-black mt-2">$249<span class="text-secondary fs-6 fw-normal">/mo</span></div>
              <p class="text-secondary small mt-1">For growing businesses</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> 5 Bots</li>
                <li><i class="fas fa-check-circle"></i> Unlimited Conversations</li>
              ...
              <a href="contact.php?service=AI%20Chatbots&plan=Pro&amount=249" class="btn-primary-custom w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Start Now</a>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <p class="text-secondary small mt-1">Full-scale automation</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> Unlimited Bots</li>
                <li><i class="fas fa-check-circle"></i> Custom Integrations</li>
                <li><i class="fas fa-check-circle"></i> Dedicated Account Manager</li>
                <li><i class="fas fa-check-circle"></i> Custom AI Training</li>
                <li><i class="fas fa-check-circle"></i> 24/7 Premium Support</li>
              </ul>
              <a href="contact.php?service=AI%20Chatbots&plan=Enterprise" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Contact Us</a>
            </div>
          </div>
        </div>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">Chatbot <span class="gold">Questions</span></h2>
        </div>
        <div class="row justify-content-center mt-3">
          <div class="col-lg-8">
            <div class="faq-item"><div class="faq-q"><span>Which platforms do you support?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Website, WhatsApp, Instagram, Facebook, and custom integrations.</div></div>
            <div class="faq-item"><div class="faq-q"><span>Can I customize the chatbot's personality?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Absolutely! We tailor each chatbot to match your brand voice and tone.</div></div>
            <div class="faq-item"><div class="faq-q"><span>How long does it take to set up?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Typically 1‑2 weeks for a standard chatbot, 3‑4 for custom AI training.</div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 position-relative overflow-hidden">
      ...
      <div class="container position-relative z-1">
        <div class="glass-gold rounded-4 p-5 text-center max-w-4xl mx-auto fade-up">
          <h2 class="section-title" style="font-size:clamp(2rem,4vw,3.5rem);">Ready for <span class="gold">AI Automation</span>?</h2>
          <p class="text-secondary fs-5 mt-3">Let's build a chatbot that works for you 24/7.</p>
