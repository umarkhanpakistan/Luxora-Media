...
<head>
  ...
  <title>Branding – Luxora Media</title>
...
<?php include 'user-nav.php'; ?>
  ...
  <main>
    ...
    <section class="d-flex align-items-center" style="min-height:50vh;padding-top:80px;background:radial-gradient(ellipse at 30% 40%, rgba(212,175,55,0.06), transparent 60%);">
      <div class="container">
        <div class="max-w-3xl fade-up visible">
          <span class="section-badge"><i class="fas fa-trademark me-1"></i> Service</span>
          <h1 class="section-title">Brand <span class="gold">Identity</span></h1>
          <p class="text-secondary fs-5 mt-3">Complete brand identity that tells your story, connects with your audience, and sets you apart.</p>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-paint-brush me-1"></i> What We Do</span>
          <h2 class="section-title">Brand <span class="gold">Services</span></h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-pen-nib fs-1 text-gold mb-2"></i><h4 class="fw-bold">Logo Design</h4><p class="text-secondary small">Unique, memorable logo creation.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-palette fs-1 text-gold mb-2"></i><h4 class="fw-bold">Color Palette</h4><p class="text-secondary small">Strategic color psychology.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-font fs-1 text-gold mb-2"></i><h4 class="fw-bold">Typography</h4><p class="text-secondary small">Font selection and pairing.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-book fs-1 text-gold mb-2"></i><h4 class="fw-bold">Brand Guidelines</h4><p class="text-secondary small">Complete style guide.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-file-signature fs-1 text-gold mb-2"></i><h4 class="fw-bold">Brand Voice</h4><p class="text-secondary small">Tone and messaging strategy.</p></div></div>
          <div class="col-md-4 fade-up"><div class="glass-card h-100"><i class="fas fa-boxes fs-1 text-gold mb-2"></i><h4 class="fw-bold">Brand Assets</h4><p class="text-secondary small">All digital and print assets.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">How We <span class="gold">Build</span> Brands</h2>
        </div>
        <div class="row g-4 mt-3">
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-search fs-1 text-gold mb-2"></i><h4 class="fw-bold">Discovery</h4><p class="text-secondary small">Research & strategy.</p></div></div>
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-lightbulb fs-1 text-gold mb-2"></i><h4 class="fw-bold">Concept</h4><p class="text-secondary small">Ideation & mood boards.</p></div></div>
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-pen-fancy fs-1 text-gold mb-2"></i><h4 class="fw-bold">Design</h4><p class="text-secondary small">Creation & refinement.</p></div></div>
          <div class="col-md-3 fade-up"><div class="glass-card text-center h-100"><i class="fas fa-rocket fs-1 text-gold mb-2"></i><h4 class="fw-bold">Launch</h4><p class="text-secondary small">Final delivery & rollout.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center fade-up">
          <span class="section-badge"><i class="fas fa-tag me-1"></i> Brand Pricing</span>
        ...
        <div class="row g-4 mt-3">
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <div class="fs-1 fw-black mt-2">$249</div>
              <p class="text-secondary small mt-1">Essential brand identity</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> Logo Design</li>
                <li><i class="fas fa-check-circle"></i> Color Palette</li>
                <li><i class="fas fa-check-circle"></i> Typography Selection</li>
                <li><i class="fas fa-check-circle"></i> 2 Revisions</li>
              </ul>
              <a href="contact.php?service=Branding&plan=Basic&amount=249" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Get Started</a>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card popular">
              ...
              <div class="fs-1 fw-black mt-2">$599</div>
              <p class="text-secondary small mt-1">Complete brand identity</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> Logo Design + Variations</li>
                <li><i class="fas fa-check-circle"></i> Full Color Palette</li>
                <li><i class="fas fa-check-circle"></i> Typography System</li>
                <li><i class="fas fa-check-circle"></i> Brand Guidelines Book</li>
                <li><i class="fas fa-check-circle"></i> Brand Voice Guide</li>
                <li><i class="fas fa-check-circle"></i> 5 Revisions</li>
              </ul>
              <a href="contact.php?service=Branding&plan=Pro&amount=599" class="btn-primary-custom w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Get Started</a>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4 fade-up">
            <div class="pricing-card">
              ...
              <p class="text-secondary small mt-1">Full-scale branding</p>
              <ul class="feature-list mt-3">
                <li><i class="fas fa-check-circle"></i> Complete Brand Identity</li>
                <li><i class="fas fa-check-circle"></i> All Brand Assets</li>
                <li><i class="fas fa-check-circle"></i> Marketing Collateral</li>
                <li><i class="fas fa-check-circle"></i> Digital Asset Library</li>
                <li><i class="fas fa-check-circle"></i> Unlimited Revisions</li>
                <li><i class="fas fa-check-circle"></i> Dedicated Designer</li>
              </ul>
              <a href="contact.php?service=Branding&plan=Enterprise" class="btn-gold-outline w-100 justify-content-center mt-3"><i class="fas fa-arrow-right me-2"></i> Contact Us</a>
            </div>
          </div>
        </div>
    ...
    <section class="py-5 bg-card/30">
      <div class="container">
        <div class="text-center fade-up">
          ...
          <h2 class="section-title">Brand <span class="gold">Questions</span></h2>
        </div>
        <div class="row justify-content-center mt-3">
          <div class="col-lg-8">
            <div class="faq-item"><div class="faq-q"><span>What does a branding package include?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Logo creation, color palette, typography, brand guidelines, and marketing assets.</div></div>
            <div class="faq-item"><div class="faq-q"><span>How long does branding take?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Typically 2‑4 weeks depending on the scope and complexity.</div></div>
            <div class="faq-item"><div class="faq-q"><span>Do you offer ongoing brand support?</span><span class="faq-icon"><i class="fas fa-plus"></i></span></div><div class="faq-a">Yes! We offer ongoing brand management and evolution services.</div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 position-relative overflow-hidden">
      ...
      <div class="container position-relative z-1">
        <div class="glass-gold rounded-4 p-5 text-center max-w-4xl mx-auto fade-up">
          <h2 class="section-title" style="font-size:clamp(2rem,4vw,3.5rem);">Ready to <span class="gold">Build</span> Your Brand?</h2>
          <p class="text-secondary fs-5 mt-3">Let's create a brand identity that stands out and connects.</p>
